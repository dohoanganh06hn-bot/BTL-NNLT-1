...
void employeeMenu(sqlite3 *DB)
{
    ...
    do
    {
        ...
        else if (choice == 2)
        {
            ...
            {
                cout << "=== Nhân viên: " << tenNV << " đã đăng nhập thành công! ===\n";
                mainMenuManagement(DB); 
                break; 
            }
            else
            {
...
void studentMenu(sqlite3 *DB)
{
    ...
    do
    {
        ...
        else if (choice == 2)
        {
            ...
            {
                cout << "=== Học sinh: " << email << " đã đăng nhập thành công! ===\n";
                mainMenuStudent(DB, sv); // ← vào menu sinh viên
                break; // thoát studentMenu
            }
            else
            {
